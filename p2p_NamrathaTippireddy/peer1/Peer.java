	...
	public void triggerPeerAsServer(int portPeerActAsSever){
		try{
			...
			while (true) {
				...
				// else{
				// 	System.out.println("*** Recieved an additioanl incoming connection.. ");
				// 	System.out.println("*** Already connected with a peer as DownloadNeighbour.. Can't take more incoming connections. ");
				// }
			}
		} catch (Exception e) {
